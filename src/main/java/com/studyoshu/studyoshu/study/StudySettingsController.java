...
import com.studyoshu.studyoshu.study.form.StudyDescriptionForm;
import com.studyoshu.studyoshu.tag.TagRepository;
import com.studyoshu.studyoshu.tag.TagService;
...
public class StudySettingsController {
    ...
    public String updateStudyBannerImage(@CurrentAccount Account account, @PathVariable String path,
        ...
        attributes.addFlashAttribute("message", "배너 이미지를 수정했습니다.");
