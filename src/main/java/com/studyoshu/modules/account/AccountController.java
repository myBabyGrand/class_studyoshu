...
import com.studyoshu.modules.account.validator.SignUpFormValidator;
...
//        model.addAttribute("signUpForm", new SignUpForm());
        model.addAttribute(new SignUpForm());//이름이 같으면 생략 가능(맨 앞 소문자에 주의)
    ...
    public String checkEmailToken(String token, String email, Model model){
        ...
        if(!account.isValidToken(token)){
            model.addAttribute("error", "wrong.email2");
            return view;
        }
